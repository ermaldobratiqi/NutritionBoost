...
<html lang="en" dir="ltr">
  <head>
    ...
    <script defer type="text/javascript" src="Scripts/AdminAddStaff.js" ></script>
  ...
  <body>
    ...
    <form id="AddArticle-form"  onsubmit="return AddStaffValidation()" method="POST">
      <div class="ArticleBox">

      <div id="Publish-items" class="items">
           <div class="L">
             <h2 id="h21">Add a member</h2>
           </div>
           ...
           <button  id="Publish" type="submit" name="Publishbuttonn">Publish Staff</button>
           </div>
           <div class="Text">
           <a href="AboutUs.php">Go to the Staff</a>  
           <br>    
         </div>
