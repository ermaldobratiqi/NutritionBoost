...
<html lang="en" dir="ltr">
  <head>
    ...
    <script defer type="text/javascript" src="Scripts/AdminAddTips.js" ></script>
  ...
  <body>
    ...
    <form id="AddTips-form"  onsubmit="return AddTipsValidation()" method="POST">
      <div class="ArticleBox">

      <div id="Publish-items" class="items">
           <div class="L">
             <h2 id="h21">Post a Tip</h2>
           </div>
           ...
           <button  id="Publish" type="submit" name="Publishbutton">Publish Tips</button>
           </div>
           <div class="Text">
           <a href="tips.php">Go to the tips</a>  
           <br>    
         </div>
